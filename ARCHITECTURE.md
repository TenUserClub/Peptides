...
News discovery uses five bounded primary-source lanes: US regulation and safety, US enforcement and courts, clinical research, international regulators, and official company disclosures. Legal and regulatory lanes use longer lookback windows than ordinary news because primary documents are less frequent. Every item is deduplicated by canonical source URL. News and legal posts must preserve the supplied primary URL and matching source class; research, trial-registry, and company sources cannot be routed into Laws & legal. Company disclosures may support only clearly attributed company-reported developments. Blog posts need at least two reachable sources from their assigned editorial brief. Humanised content keeps the original frontmatter and is rejected for em dashes or repeated stock AI-writing phrases. Clinic listings require a matching verified clinic record. Doctor profiles require a matching NPI record; roundups require a methodology and matching verified records.
